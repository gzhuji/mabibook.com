...
$FilterDir = "+|app|bbs|bbslogo|bh|dev|font|images|p|pin|Scripts|smil|smil|swf|t|tool|tu|up|upcalc|w|weather|wp|tw|dun|en|";
#要索引的文件扩展名[小写]
$IndexFileExt = "+|txt|";
#XML头部
...
$forend="<url>\n<loc>".$GLOBALS["WebRoot"]."index.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."bbs/index.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."mod/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."mod/rand.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."mod/title.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."mod/ena.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."mod/name.php</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."dun/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."tw/shop/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."en/shop/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."tw/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."en/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."tu/</loc>\n</url>\n<url>\n<loc>".$GLOBALS["WebRoot"]."w/</loc>\n</url>\n<loc>".$GLOBALS["WebRoot"]."mod/pin.php</loc>\n</url>\n<loc>".$GLOBALS["WebRoot"]."mod/forgod.php</loc>\n</url>\n";
