...
$FilterDir = "+|app|bbs|bbslogo|bh|dev|font|images|p|pin|Scripts|smil|smil|swf|t|tool|tu|up|upcalc|w|weather|wp|en|tw|";
#要索引的文件扩展名[小写]
$IndexFileExt = "+|txt|";
#XML头部
...
$s = "<url>\n<loc>".$GLOBALS["WebRoot"]."dun/iknow.php?h=".$f."</loc>\n<lastmod>".$dt."</lastmod>\n</url>\n";
